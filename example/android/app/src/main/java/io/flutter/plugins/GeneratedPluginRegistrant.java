...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.m7_livelyness_detection.M7LivelynessDetectionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin m7_livelyness_detection, com.example.m7_livelyness_detection.M7LivelynessDetectionPlugin", e);
    }
    try {
